...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar  elevation-4">
      <?php
      include '../fragments/main_aside_secados.php'
        ?>
    </aside><!--  Main Sidebar  -->
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Vacas Secas</li>
              </ol>
            </div>
            <div class="col-sm-6">
              <h1 class="m-0"></h1>
            ...
            <div class="col-10">
              <div class="card " style="background-color:#4CAF50;">
                <div class="card-header text-center">
                  <h3 class="card-title text-white">Nuevo Secado</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="formulario-agregar" method="POST">
                  <div class="card-body text-white ">
                    <div class="row">
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          <label for="">Fecha del Secado</label>
                          <input type="date" class="form-control" id="fechaSecado" name="fechaSecado" required>
                        </div>
...
<!-- JD Scripts -->
<script src="../assets/js/secados.js"></script>
